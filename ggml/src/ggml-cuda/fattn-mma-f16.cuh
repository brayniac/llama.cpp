...
// Removed 80x80 config for Ada Lovelace minimal build

// Removed 96x96 config for Ada Lovelace minimal build

// Removed 112x112 config for Ada Lovelace minimal build
...
// Removed 576x512 DeepSeek config for Ada Lovelace minimal build
...
// Removed 80, 96, 112 declarations for Ada Lovelace minimal build
...
// Removed DeepSeek 576x512 declarations for Ada Lovelace minimal build
